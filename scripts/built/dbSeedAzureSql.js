...
exports.seedAzureSqlDatabase = seedAzureSqlDatabase;
exports.main = main;
...
function getAzureSqlConfig() {
    ...
    return {
        ...
        database: ((_a = process.env.AZURE_SQL_DATABASE) === null || _a === void 0 ? void 0 : _a.trim()) || DEFAULT_AZURE_SQL_DATABASE,
        options: {
            encrypt: true,
...
function insertRows(pool, tableName, columns, rows) {
...
function seedAzureSqlDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield pool.request().batch(AZURE_SQL_SCHEMA_SQL);
            yield insertRows(pool, 'sources', seedNormalizedDatabase_1.SOURCE_COLUMNS, data.sources);
            yield insertRows(pool, 'lookups', seedNormalizedDatabase_1.LOOKUP_COLUMNS, data.lookups);
            yield insertRows(pool, 'entities', seedNormalizedDatabase_1.ENTITY_COLUMNS, data.entities);
            yield insertRows(pool, 'features', seedNormalizedDatabase_1.FEATURE_COLUMNS, data.features);
            yield insertRows(pool, 'spells', seedNormalizedDatabase_1.SPELL_COLUMNS, data.spells);
            yield insertRows(pool, 'items', seedNormalizedDatabase_1.ITEM_COLUMNS, data.items);
            yield insertRows(pool, 'actors', seedNormalizedDatabase_1.ACTOR_COLUMNS, data.actors);
            yield insertRows(pool, 'links', seedNormalizedDatabase_1.LINK_COLUMNS, data.links);
            console.log(`Seeded Azure SQL database: ` +
